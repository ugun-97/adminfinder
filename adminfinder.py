...
def Logo():
	run()
	subprocess.call("toilet -f standard -F gay Bartes Dwiky",shell=True)
...
while(angka<1):
    run()
    mengetik(D+'\n  SCAN ADMIN LOGIN')
    mengetik(C+"  By: BARTES DWIKY")
    mengetik(G+"  Team: CLAY HACKER TEAM")
    mengetik(I+"  Thanks To: AllMember Clay Hacker Team")
    mengetik(I+"  Tulis Website Tanpa  http:// !!")

    angka+=1
    time.sleep(1)


site00 = raw_input("Masukan Website Target :")
